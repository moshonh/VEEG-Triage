...
{
  "urgency_score": <1-10>,
  "score_label": "דחיפות נמוכה" | "דחיפות בינונית" | "דחיפות גבוהה",
  "patient_summary": "שורה אחת – תיאור קצר של המקרה",
  "clinical_highlights": ["נקודה 1", "נקודה 2", "נקודה 3"],
  "clinical_justification": "הסבר קצר לציון",
  "logistics_note": "הערה לוגיסטית למזכירות (זמינות / בדיקה קודמת)"
}
"""
